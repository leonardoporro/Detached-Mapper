...
{
    public class KeyServices<TEntity> : IKeyServices<TEntity>, IKeyServices
    {
        #region Fields
        ...
        public object[] GetValues(object entity)
        {
        ...
        {
            return StructuralComparisons.StructuralEqualityComparer.GetHashCode(GetValues(entity));
        }
        ...
        public Dictionary<object[], object> CreateTable(IEnumerable entities)
        {
            ...
            {
                table.Add(GetValues(entity), entity);
            }
            return table;
        }
